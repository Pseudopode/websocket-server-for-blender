...
# Version 0.5.0
# Copyright 2020 Jean-Philippe Deblonde
# Original copyright 2015 Jonathan Giroux (Bloutiouf)
# Licensed under MIT (http://opensource.org/licenses/MIT)

# Plugin Template adapted from: https://blender.stackexchange.com/a/128409
...
bl_info = {
	...
	"description": "Send Blender's state over a WebSocket connection. Updated to 2.8X",
	"author": "JP Deblonde. Original author: Jonathan Giroux",
	"version": (0, 5, 0),
	"blender": (2, 80, 0),
...
class WebSocketServerSettings( AddonPreferences ):
	...
	def draw(self, context):
		print('Drawing preferences panel')
		layout = self.layout
